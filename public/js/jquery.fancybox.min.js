    ...
    $.extend(true, $.fancybox.defaults, {
        ...
        share : {
            ...
            '<a href="https://www.facebook.com/sharer/sharer.php?u=' +
             $(location).attr('host')+"/post/" +
            '{{src}}" target="_blank" class="fancybox-share_button">' +
            ...
            $(location).attr('host')+"/post/" +
            '{{src}}&amp;description={{descr}}" target="_blank" class="fancybox-share_button">' +
            ...
            $(location).attr('host')+"/post/" +
            '{{src}}&amp;text={{descr}}" target="_blank" class="fancybox-share_button">' +
